                ...
                for routePathComponent in routePathComponents {
                    ...
                    if let component = component {
                        if routePathComponent.hasPrefix(":") {
                            ...
                            let variableKey = routePathComponent.substring(with: (routePathComponent.characters.index(routePathComponent.startIndex, offsetBy: 1))..<routePathComponent.characters.endIndex)
